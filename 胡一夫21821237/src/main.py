...
def main():
  ...
  cost_to_run = cost_total

  ori0=content_img[0][150][150][0]
  ori1=content_img[0][151][150][0]

  for i in range(490-123,541-123,5):
    content_img[0][150][150][0] = i
    for j in range(-265-123,-229-123,5):
      content_img[0][151][150][0] = j
      sess.run(net['input'].assign(content_img))
      print(i+123, j+123, sess.run(cost_to_run))
